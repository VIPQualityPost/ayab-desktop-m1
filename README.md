...
* It may cause problems if you install both the native and rosetta versions of apps. You can remove the conflicting one from brew with `brew remove xyz` or by finding and removing the conflicting packages in `\opt\homebrew\`.

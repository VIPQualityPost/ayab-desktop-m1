...
* It may cause problems if you install both the native and rosetta versions of apps. You can remove the conflicting one from homebrew with `brew remove xyz`.
